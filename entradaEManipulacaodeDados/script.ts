...
console.log(`A sua idade no ano atual é ${2024 - nascimento}`)
...
console.log(`${num % 2 == 0 ? 'é par' : "é ímpar"}`)

//questao17
console.log(`${num >= 0 ? 'é positivo' : "é negativo"}`)
...
console.log(`${estadoCivil == "solteiro" || estadoCivil == "solteira" ? "Voce é solteiro" : estadoCivil == "casado" || estadoCivil == "casada" ? "Você é casado" : "você não é nada"}`)
...
console.log(`O resto da divisão dos números que você digitou é: ${(numeroDecimal1 % numeroDecimal2).toFixed(2)}`)

//questao25
let digito = Number(prompt("Digite um número decimal: "))
